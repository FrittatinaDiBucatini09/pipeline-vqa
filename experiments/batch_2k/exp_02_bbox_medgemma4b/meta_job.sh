...
#SBATCH --job-name=exp02_bbox_mg4b
#SBATCH --output=/home/rbalzani/medical-vqa/Thesis/orchestrator_runs/batch_2k_bbox_medgemma4b_20260225_034316/slurm_metajob_%j.out
#SBATCH --error=/home/rbalzani/medical-vqa/Thesis/orchestrator_runs/batch_2k_bbox_medgemma4b_20260225_034316/slurm_metajob_%j.err
#SBATCH -N 1
...
export ORCH_OUTPUT_DIR="/home/rbalzani/medical-vqa/Thesis/orchestrator_runs/batch_2k_bbox_medgemma4b_20260225_034316"
# WandB: group all stages of this meta-job under a shared run group in the UI
export WANDB_RUN_GROUP="$(basename \"/home/rbalzani/medical-vqa/Thesis/orchestrator_runs/batch_2k_bbox_medgemma4b_20260225_034316\")"
...
echo "Run directory: /home/rbalzani/medical-vqa/Thesis/orchestrator_runs/batch_2k_bbox_medgemma4b_20260225_034316"
echo "Stages: 3"
...
# --- CACHE CHECK: bbox_preproc ---
CACHE_RESULTS_DIR="/home/rbalzani/medical-vqa/Thesis/preprocessing/bounding_box/results"
CACHE_CONFIG_FILE="/home/rbalzani/medical-vqa/Thesis/preprocessing/bounding_box/configs/gemex/exp_01_vqa.conf"
...
if [ "$CACHE_HIT" = "true" ]; then
    echo "[CACHE-HIT] Identical preprocessing detected for bbox_preproc. Skipping to next stage..."
else
    ...
    echo "[CACHE-MISS] Running bbox_preproc..."

    cd "/home/rbalzani/medical-vqa/Thesis/preprocessing/bounding_box"
bash submit_bbox_preprocessing.sh configs/gemex/exp_01_vqa.conf

    # Record cache state after successful completion
    python3 "$CACHE_UTIL" write $CACHE_ARGS
    echo "[CACHE] State recorded for bbox_preproc."
fi
# --- END CACHE CHECK: bbox_preproc ---
...
export PREPROC_TYPE="bbox_preproc"
