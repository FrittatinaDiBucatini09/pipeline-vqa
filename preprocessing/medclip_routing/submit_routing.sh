#!/bin/bash
# ==============================================================================
# SLURM SUBMISSION SCRIPT: MedCLIP Agentic Routing
# ==============================================================================
# Description:
#   Orchestrates the submission of the agentic routing job to the HPC cluster.
...
#SBATCH --job-name=medclip_routing
#SBATCH --output=slurm_medclip_routing_%j.out
#SBATCH --error=slurm_medclip_routing_%j.err
...
if [ -n "$1" ]; then
    ...
    TARGET_CONFIG="configs/default.conf"
fi
...
./scripts/run_docker.sh "$TARGET_CONFIG"
